...
public class TestEntityCreationAPI : MonoBehaviour
{
    ...
    public struct SpawnJob : IJobParallelFor
    {
        ...
        public void Execute(int index)
        {
            ...
            Ecb.SetComponent(index, e, MaterialMeshID.FromRenderMeshArrayIndices(0, meshIndex));
    ...
    void Start()
    {
        ...
        var renderMeshArray = new RenderMeshArray(new List<Material>() {Material}, Meshes);
