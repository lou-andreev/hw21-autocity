...
public class AddComponentsExample : MonoBehaviour
{
    ...
    public struct SpawnJob : IJobParallelFor
    {
        ...
        public void Execute(int index)
        {
            ...
            Ecb.SetComponent(index, e, MaterialMeshID.FromRenderMeshArrayIndices(matIndex, 0));
...
//        var meshArray = new RenderMeshArray() { Materials = matList, Meshes = new List<Mesh> { Mesh } };
        var meshArray = new RenderMeshArray() { Materials = matList, Meshes = new List<Mesh> { Mesh } };
        ...
        RenderMeshUtility.AddComponents(
            ...
            desc,
            meshArray,
            MaterialMeshID.FromRenderMeshArrayIndices(0, 0));
